...
<html>
    ...
    <body>
        ...
        <ul>
            <li>Recreate the first part of the <i>looping statments: while</i> exercise using the for loop:
                <ul>
        ...
        <ul>
            ...
            <li>Recreate the first part of the <i>looping statments: while</i> exercise using the for loop:
                <ul>
                    ...
                    <li>
                        Now make sure that the cells with even numbers get a green background, use a CSS class for this and no inline styles.
                        <span class="tip">Work with a shorthand if-statement</span>
                    </li>
                </ul>
            </li>
        </ul>
